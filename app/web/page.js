    ...
    return (
        <div className='overflow-x-hidden'>
            ...
            <div className='flex justify-center items-center flex-col px-8 lg:px-24 py-24 lg:py-36 bg-dark-geo bg-cover'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 md:gap-16 justify-items-center items-center md:max-w-[80%] mb-24'>
                    <Card goToContact
                        title={`Design`}
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 md:gap-16 justify-items-center items-center md:max-w-[80%] mb-20'>
