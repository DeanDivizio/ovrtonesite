    ...
    return (
        <div className='overflow-x-hidden'>
            <div className='flex flex-col justify-center lg:flex-row lg:justify-around p-20 text-center lg:text-left items-center w-screen min-h-screen bg-cover bg-web-hero'>
                <h1 className="bg-gradient-green bg-clip-text text-transparent text-4xl md:text-5xl 3xl:text-[8rem] mb-12 font-semibold">Pricing</h1>
            </div>
            <div className="flex justify-center items-start flex-col px-8 lg:px-32 py-24 lg:py-36">
                <h2 className="mb-8 text-5xl md:text-7xl leading-snug"><span className="font-semibold">Transparancy</span>{` - Our Commitment to You`}</h2>
                <p className="mb-6 text-2xl md:text-3xl"><em>{`Every project is unique so pricing will vary, but we believe it's in line with our commitment to transparancy to make our pricing information as standardized and available as possible.`}</em></p>
            </div>
            <div className='flex justify-center items-center flex-col px-8 lg:px-24 py-24 lg:py-36 bg-dark-geo bg-cover'>
             ...
             <div className="flex flex-col px-8 py-24 lg:py-36 justify-around items-center">
                <h2 className="mb-16 text-5xl md:text-7xl leading-snug text-center">{`Hear from a Previous Client`}</h2>
                <Testimonial 
                name="Brett Carlson"
